   ...
   render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'role',
        render: (text, record) => (
            <span className={text !="Active" ? "badge bg-inverse-danger" :  "badge bg-inverse-success" }
           >{text}</span>
          ),
              ...
              <div className="content container-fluid">
                ...
                <div className="page-header">
                  <div className="row align-items-center">
                    <div className="col">
                      <h3 className="page-title">API Key</h3>
                      ...
                      <form>
                        <div className="row">
                          ...
                          <div className="col-sm-6">
                            <div className="form-group">
                              <label>Copy Percent</label>
                              <input className="form-control" defaultValue="50" type="text" />
                            </div>
                          </div>
                          <div className="col-sm-6">
                            <div className="form-group">
